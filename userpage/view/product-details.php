                            ...
                            <div class="col-lg-6">
                                <div class="product-pic-zoom">
                                    ...
                                    $products = $dbCon->getALLData($query);
                                      foreach ($products as $ten){
                                          if($ten['masanpham']==$masanpham){
                                              $sanpham = $ten;
                                          }
                                      }
                                        
                                    echo'<img class="product-big-img" src="img/products/'.$sanpham['image'].'" alt="">';
                                    $dbCon->disconnectDB();
                                    ?>
                            ...
                            <div class="col-lg-6">
                                <div class="product-details">
                                    ...
                                    <div class="pd-desc">
                                        ...
                                        <h4><?php echo $sanpham['price'] . "$" ?> <span>629.99</span></h4>
                                    </div>
                                    <div class="pd-color">
                                        <h6>Color</h6>
...
<!--                                            <div class="pro-qty">  
                                            ...
                                            <a href="../controller/add_cart.php?id= <?php echo $sanpham["masanpham"]; ?>" class="primary-btn pd-cart">Add To Cart</a>
                                        </div>
                                    </form>
                                    <ul class="pd-tags">
