                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="../controller/CatalogyController.php" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="txt_id" readonly value="<?php echo $madanhmuc; ?>" class="form-control"  required="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Catalogy Name</label>
                                            <div class="col-sm-10">
                                                <input name="txt_name" value="<?php echo $danhmuc['catname']; ?>" class="form-control" required="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">URL</label>
                                            <div class="col-sm-10">
                                                <input name="txt_url" value="<?php echo $danhmuc['caturl']; ?>" class="form-control" required="true">
                                            </div>
                                        </div>
